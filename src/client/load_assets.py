...
sound_debug_enable = pygame.mixer.Sound(audio_dir / "debug_enable.mp3")
sound_debug_enable.set_volume(0.2)
sound_debug_disable = pygame.mixer.Sound(audio_dir / "debug_disable.mp3")
sound_debug_disable.set_volume(0.3)
