...
FONTS = {
    25: pygame.font.SysFont(FONT_STYLE, 25),
    40: pygame.font.SysFont(FONT_STYLE, 40),
    50: pygame.font.SysFont(FONT_STYLE, 50),
    60: pygame.font.SysFont(FONT_STYLE, 60),
    80: pygame.font.SysFont(FONT_STYLE, 80),
    90: pygame.font.SysFont(FONT_STYLE, 90),
    120: pygame.font.SysFont(FONT_STYLE, 120),
}
